...
public class Album implements Serializable{
   ...
   private List<Chapter> children;
    ...
    public Album(String id, String title, Integer count, String corverImg, Double score, String author, String broadCast, String brife, Date publicDate, Date createDate, String status) {
        this.id = id;
        this.title = title;
        this.count = count;
        this.corverImg = corverImg;
